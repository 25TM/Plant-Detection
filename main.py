...
if app_mode == "Home":
    ...
    image_path = 'w.jpg'  # Update this path if necessary
    try:
        st.image(image_path, use_column_width=True)
    except FileNotFoundError:
        st.error(f"File {image_path} not found. Please check the path.")
    except Exception as e:
        ...
        if st.button("Predict"):
            try:
                ...
                if result_index is not None:
                    ...
                    st.error("Prediction failed. Please check the image and model.")
            except Exception as e:
